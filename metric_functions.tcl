...
oo::class create meter {
	...
	constructor { args } {
		...
		if {$_width < [rescale_x_skin 300]} {
			set _label_font "Mazzard Medium 12"
			set _title_font "Mazzard Regular 12"
		} elseif {$_width < [rescale_x_skin 600]} {
			set _label_font "Mazzard Medium 18"
			set _title_font "Mazzard Regular 20"
		} else {
			set _label_font "Mazzard Medium 22"
			set _title_font "Mazzard Regular 24"
		}

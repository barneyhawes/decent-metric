...
add_visual_items_to_contexts $status_bar_contexts $water_meter_background_id
...
add_visual_items_to_contexts $status_bar_contexts $temperate_meter_background_id
...
proc set_status_message_visibility {} {
	if {![is_connected]} {
		...
		.can itemconfigure $::connection_message_background_id -fill $::color_background

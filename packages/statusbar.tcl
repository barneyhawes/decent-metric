...
create_symbol_button $status_function_contexts 1810 1400 200 220 $::symbol_power [translate "sleep"] { say [translate "settings"] $::settings(sound_button_in); start_sleep }

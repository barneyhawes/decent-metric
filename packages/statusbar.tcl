set status_meter_contexts "off espresso_menu espresso_config steam_menu steam water_menu water flush_menu flush"
set status_message_contexts "off espresso_menu espresso_config espresso espresso_done steam_menu steam water_menu water flush_menu flush"
...
set ::temperature_meter [meter new -x [rescale_x_skin 60] -y [rescale_y_skin 1310] -width [rescale_x_skin 280] -minvalue 0.0 -maxvalue 100.0 -get_meter_value get_machine_temperature -get_target_value get_min_machine_temperature -tick_frequency 10.0 -label_frequency 20 -needle_color $::color_temperature -label_color $::color_grey_text -tick_color $::color_status_bar -contexts $status_meter_contexts -title [translate "Head temperature"] -units [return_html_temperature_units]]

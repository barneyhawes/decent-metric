add_background "off"
add_home_button "off" 120 $::symbol_espresso [translate "espresso"] $::color_menu_background $::color_text {say [translate "espresso"] $::settings(sound_button_in); set ::metric_drink "A"; load_metric_settings; metric_jump_to "espresso_menu" }
add_home_button "off" 420 $::symbol_filter [translate "pour over"] $::color_menu_background $::color_text {say [translate "filter"] $::settings(sound_button_in); set ::metric_drink "B"; load_metric_settings; metric_jump_to "espresso_menu" }

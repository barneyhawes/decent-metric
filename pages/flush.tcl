...
set ::flush_action_button_id [create_action_button "flush_menu" 1280 1020 [translate "flush"] $::font_action_label $::color_text $::symbol_flush $::font_action_button $::color_action_button_start $::color_action_button_text {say [translate "flush"] $::settings(sound_button_in); do_start_flush } ""]
create_action_button "flush" 1280 1020 [translate "stop"] $::font_action_label $::color_text $::symbol_hand $::font_action_button $::color_action_button_stop $::color_action_button_text {say [translate "stop"] $::settings(sound_button_in); metric_jump_back} "fullscreen"

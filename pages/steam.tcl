...
create_symbol_button "steam" 390 600 20 [translate "steam"] $::symbol_steam $::color_menu_background { say [translate "steam"] $::settings(sound_button_in); set ::settings(steam_flow) 50; set_steam_flow 50; set_steam_button_colors }
...
create_symbol_button "steam" 790 600 20 [translate "steamy"] $::symbol_steam $::color_menu_background { say [translate "steamy"] $::settings(sound_button_in); set ::settings(steam_flow) 100; set_steam_flow 100; set_steam_button_colors }
...
create_symbol_button "steam" 1190 600 20 [translate "steamier"] $::symbol_steam $::color_menu_background { say [translate "steamier"] $::settings(sound_button_in); set ::settings(steam_flow) 150; set_steam_flow 150; set_steam_button_colors }
...
create_symbol_button "steam" 1590 600 20 [translate "steamiest"] $::symbol_steam $::color_menu_background { say [translate "steamiest"] $::settings(sound_button_in); set ::settings(steam_flow) 200; set_steam_flow 200; set_steam_button_colors }
...
create_symbol_button "steam" 1990 600 20 [translate "steamongous"] $::symbol_steam $::color_menu_background { say [translate "steamongous"] $::settings(sound_button_in); set ::settings(steam_flow) 250; set_steam_flow 250; set_steam_button_colors }
